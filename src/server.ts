...
import clientCors, { authorityCors } from './libs/cors'
...
class ExpressServer {
  ...
  private _routes(): void {
     ...
     * External services
     */
    this.express.use('/v1/client/auth', cors(clientCors), authClientController.router)
    /**
     * Internal services
     */
    ...
    this.express.use('/v1/plans/', planController.router)
