...
export const checkUniqueUsername = (username: string, provider_id: string) =>
...
export const checkUniqueEmail = (email: string, provider_id: string) =>
  prismadb.users.findFirst({
    select: { user_id: true },
    where: {
...
export const clientExists = (user_id: string, provider_id: string) =>
  prismadb.users.findFirst({
    select: { user_id: true },
    where: {
      user_id,
...
export const getUserByUsername = (username: string, provider_id: string) =>
  prismadb.users.findFirst({
...
export const getCurrentUser = (user_id: string, provider_id: string) =>
  prismadb.users.findFirst({
    where: {
      user_id,
      consumers: {
...
export const getForgeter = (user: string, provider_id: string) =>
  prismadb.users.findFirst({
    where: {
      isActive: true,
